...
class EditMessageTest(ZulipTestCase):
    ...
    def test_visible_edit_history_for_message(self) -> None:
        ...
        self.assert_length(message_edit_history_moves_only, 4)
        ...
        self.assertEqual(message_edit_history_moves_only[3]["topic"], "topic 4")
        self.assertEqual(message_edit_history_moves_only[3]["prev_topic"], "topic 3")
        self.assertEqual(message_edit_history_moves_only[3]["stream"], stream_3.id)
        self.assertEqual(message_edit_history_moves_only[3]["prev_stream"], stream_2.id)

        do_set_realm_property(
            user.realm,
            "message_edit_history_visibility",
            MessageEditHistoryVisibilityEnum.MESSAGE_EDIT_HISTORY_VISIBILITY_ALL,
            acting_user=None,
        )
