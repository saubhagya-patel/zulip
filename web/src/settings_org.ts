...
type OrganizationSettingsOptions = {
    ...
    message_edit_history_visibility_policy_values: SettingOptionValueWithKey[];
};
...
export function get_organization_settings_options(): OrganizationSettingsOptions {
    return {
        ...
        message_edit_history_visibility_policy_values: settings_components.get_sorted_options_list(
