...
function set_welcome_message_custom_text_setting(): void {
...
export function set_welcome_message_custom_text_visibility(): void {
    ...
    $("input#id_realm_set_welcome_message_custom_text").prop(
        "checked",
...
export function discard_realm_property_element_changes(elem: HTMLElement): void {
    ...
    switch (property_name) {
        ...
        case "realm_welcome_message_custom_text":
            set_welcome_message_custom_text_setting();
            break;
        default:
...
export function register_save_discard_widget_handlers(
    ...
    $container.on("change input", "input, select, textarea", function (this: HTMLElement, e) {
        ...
        if ($(this).hasClass("realm_set_welcome_message_custom_text")) {
